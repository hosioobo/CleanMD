...
- The downloadable app is packaged locally and ad-hoc signed.
- The app is not notarized yet, so macOS Gatekeeper may show a warning the first time you open it.
