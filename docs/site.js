...
function trackSiteEvent(kind, label) {
    // Intentionally local no-op: keep data-track-click hooks stable without
    // sending visitor activity to a third-party analytics endpoint.
    void sanitizeEventKey([kind, label].filter(Boolean).join("-"));
}
